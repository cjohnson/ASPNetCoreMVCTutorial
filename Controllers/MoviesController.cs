...
namespace ASPNetCoreMVCTutorial.Controllers
{
    ...
    {
        private readonly ASPNetCoreMVCTutorialContext _context;

        public MoviesController(ASPNetCoreMVCTutorialContext context)
        {
            _context = context;
        }
            ...
            string searchString)
        {
            ...
            {
                return Problem("Entity set 'ASPNetCoreMVCTutorialContext.Movie' is null.");
            }
